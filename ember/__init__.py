...
def create_vectorized_features(data_dir, save_dir, feature_version=2):
    """
    ...
    X_path = os.path.join(save_dir, "X_test.dat")
    y_path = os.path.join(save_dir, "y_test.dat")
...
def create_metadata(data_dir, save_dir):
    """
    ...
    train_metadf.to_csv(os.path.join(save_dir, "train_metadata.csv"))
    ...
    test_metadf.to_csv(os.path.join(save_dir, "test_metadata.csv"))
    ...
    metadf.to_csv(os.path.join(save_dir, "metadata.csv"))
    return metadf
